 ...
 */
example.shape.DependsConnection = draw2d.shape.state.Connection.extend({

    NAME : "example.shape.DependsConnection",
	...
	init : function()
    {
        ...
        this.label = new draw2d.shape.basic.Label("depends on");
