 ...
 */
draw2d.shape.state.OntologyMainAttribute = draw2d.shape.layout.VerticalLayout.extend({

	NAME: "draw2d.shape.state.OntologyMainAttribute",
    ...
    init : function()
    {
        ...
        if(this.code==null){
        	this.code = new draw2d.shape.basic.Code("Code Here!");        	
        }
        ...
        // UI representation
        this.setStroke(1);
        this.setColor("#db0029");
        this.setRadius(5);  
        
        // Compose the top row of the shape
        //
        var top = this.createLabel("Main Attribute").setStroke(0);        
        this.label = top;
        ...
        this.label = new draw2d.shape.basic.Label("Main Attribute Name");
