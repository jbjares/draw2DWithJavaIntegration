 ...
 */
example.command.CommandSetCode = draw2d.command.Command.extend({
     ...
     */
    init: function(figure, newCode)
    {
       this._super("Change the code of a figure");
       this.figure  = figure;
       this.oldCode =figure.getCode();
    ...
    execute:function()
    {
        this.figure.setCode(this.newCode);
    },
    ...
    undo:function()
    {
        this.figure.setCode(this.oldCode);
    }
