...
example.propertypane.PropertyPaneClass = Class.extend({
	...
	injectPropertyView: function( domId)
	{
	    var view = $("<form class='form-horizontal'>"+
	                 ...
	                 "   <label class='control-label' for='classNameProperty'>Name </label>"+
	                 "   <div class='controls'>"+
	                 "      <input id='classNameProperty' class='input-xlarge' type='text' value='"+this.figure.getLabel()+"'/>"+
	                 "   </div>"+
	                 "</div>"+
	                 "</form>");
	    var input = view.find("#classNameProperty");
