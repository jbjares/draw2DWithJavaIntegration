 ...
 */
example.shape.DecreaseConnection = draw2d.shape.state.Connection.extend({

    NAME : "example.shape.DecreaseConnection",
	...
	init : function()
    {
        ...
        this.label = new draw2d.shape.basic.Label("decreases with");
