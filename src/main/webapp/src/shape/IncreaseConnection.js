 ...
 */
example.shape.IncreaseConnection = draw2d.shape.state.Connection.extend({

    NAME : "example.shape.IncreaseConnection",
	...
	init : function()
    {
        ...
        this.label = new draw2d.shape.basic.Label("increases with");
