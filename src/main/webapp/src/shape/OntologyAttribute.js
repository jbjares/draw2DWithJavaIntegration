 ...
 */
draw2d.shape.state.OntologyAttribute = draw2d.shape.layout.VerticalLayout.extend({

	NAME: "draw2d.shape.state.OntologyAttribute",
    ...
    init : function()
    {
        ...
        // UI representation
        this.setStroke(1);
        this.setColor("#228cb3");
        this.setRadius(5);  
        
        // Compose the top row of the shape
        //
        var top = this.createLabel("Attribute").setStroke(0);
        this.label = top;
        ...
        this.label = new draw2d.shape.basic.Label("Attribute Name");
